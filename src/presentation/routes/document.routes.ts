...
router.post("/upload", validateToken, upload.single("pdffile"), (req, res) => controller.upload(req, res));
...
router.post("/:id/version", validateToken, upload.single("pdffile"), (req, res) => controller.uploadVersion(req, res));
router.get("/:id/compare", validateToken, (req, res) => controller.compare(req, res));
